...
Kimigayo OSは、Alpine Linuxの設計思想を受け継いだ軽量・高速・セキュアなオペレーティングシステムです。最小限のリソース使用量で高いパフォーマンスを提供し、コンテナ環境、組み込みデバイス、サーバー環境をターゲットとし、ベースイメージサイズ5MB以下を目標とします。
...
**ユーザーストーリー:** システム管理者として、最小限のベースオペレーティングシステムが欲しい。軽量なコンテナと組み込みシステムを最小限のリソースオーバーヘッドでデプロイできるようにするため。
